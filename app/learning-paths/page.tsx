...
import DAGKnowledgeGraph from '@/components/learning/DAGKnowledgeGraph'
      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          ...
          <div className="flex justify-center md:justify-start">
            <div className="inline-flex rounded-xl bg-slate-900 p-1 border border-slate-800" role="group" aria-label="View switch toggle">
              <button
        ...
        {viewMode === 'dag' ? (
          /* Render DAG Knowledge Graph View */
          <div className="pt-4 border-t border-slate-800/80">
            <DAGKnowledgeGraph completedLessons={progress.completedLessons} />
          </div>
        ) : (
          /* Render Flat list paths View */
          <>
