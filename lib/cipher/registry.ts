...
export const CIPHER_REGISTRY: CipherDefinition[] = [
  ...
  },
  {
    ...
    category: 'classical',
    description: 'A digraph substitution cipher using two standard alphabets and two keyed 5x5 matrices to encrypt pairs of letters.',
    defaultKey: 'EXAMPLE,KEYWORD',
    defaultInput: 'HELPMEOBIWANKENOBI',
    securityStatus: 'broken',
    keyPlaceholder: 'Two keywords (e.g. EXAMPLE,KEYWORD)',
    prerequisites: ['playfair'],
    recommendedNext: ['bifid', 'adfgvx'],
  },
  {
    id: 'scrypt',
    name: 'Scrypt',
    category: 'hash',
    description: 'A memory-hard key derivation function (RFC 7914) designed to be computationally and memory-intensive to defeat custom hardware attacks.',
    defaultKey: '',
    defaultInput: 'password',
    securityStatus: 'secure',
    options: [
      { name: 'Cost Parameter (N)', id: 'N', type: 'number', default: 16384 },
      { name: 'Block Size (r)', id: 'r', type: 'number', default: 8 },
      { name: 'Parallelization (p)', id: 'p', type: 'number', default: 1 },
      { name: 'Key Length (dkLen)', id: 'dkLen', type: 'number', default: 32 },
    ],
  },
];
