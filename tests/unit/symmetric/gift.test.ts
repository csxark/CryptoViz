...
import { encrypt, decrypt, TEST_VECTORS } from '@/lib/cipher/symmetric/gift'

describe('GIFT-64', () => {
    it('matches CHES 2017 test vector', () => {
    ...
    it('throws for key not 16 bytes', () => {
        expect(() => encrypt('0000000000000000', '0011')).toThrow()
    })

    it('throws for input not 8 bytes', () => {
